        ...
        for i, file_obj in enumerate(self.database.file_obj_list):
            ...
            if not file_obj['flag']:
                ...
                total_frames = mot_processing(
                    ...
                    radius=cfg['radius'],
                    contact_iou_threshold=cfg['contact_iou_threshold'],
                    contact_interval_threshold=cfg['contact_interval_threshold']
                )
...
def mot_processing(src_video_path, result_dir, input_shape, cuda, confidence,
                   nms_iou, max_age, min_hints, iou_threshold, optimize_rate,
                   st_ratio, colors, w, h, total_frames, fps, center_x, center_y,
                   radius, contact_iou_threshold, contact_interval_threshold):
    """
    ...
    get_individual_math_results(
        ...
        contact_interval_threshold=contact_interval_threshold
    )
    # 计算绘图
    draw_math_results(
