...
class Database(object):
    ...
    def export_excel(self):
        ...
        header_names = ['VideoName', 'TotalFrames', 'FPS', 'Resolution', 'AverageSpeed', 'AverageSwing',
                        'AverageContactTime', 'AverageContactNumber', 'AverageInOutNumber']
        ...
        for i, file_obj in enumerate(self.file_obj_list):
            ...
            worksheet.write(i + 1, 6, str(result['aver_contact_time']), content_style)
            worksheet.write(i + 1, 7, str(result['aver_contact_number']), content_style)
            worksheet.write(i + 1, 8, str(result['aver_in_out_number']), content_style)
        workbook.close()
